...
monogatari.script ({
	...
	'Start': [
		...
		'play voice dika_intro_2',
		`dika:angry Rockst*r bab* anj**g tol**! Rockstar- astaga, astaghfirullah aku toxic. Tapi Rockst*r kayak bab*.`,
		'show scene office with fadeIn duration 1s',
		'show character maudi neutral with exclaim',
		'play voice maudy_intro_3',
		`maudi Haah...`,
		`narrator Helaan nafas dapat terdengar dari wanita itu`,
		'play voice maudy_intro_4',
